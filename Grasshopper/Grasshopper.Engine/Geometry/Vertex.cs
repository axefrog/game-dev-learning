...
namespace Grasshopper.Engine.Geometry
{
	...
	public struct Vertex
	{
		...
		public Vertex(float pX, float pY, float pZ, Color4 color)
		...
		public Vertex(float pX, float pY, float pZ, float nX, float nY, float nZ, Color4 color)
		...
		/// <param name="color"></param>
		public Vertex(float pX, float pY, float pZ, Vector3 normal, Color4 color)
		...
		/// <param name="normal"></param>
		/// <param name="color"></param>
		public Vertex(Vector3 position, Vector3 normal, Color4 color, Vector2 uv)
		{
			Position = position;
			Normal = normal;
			Color = color;
