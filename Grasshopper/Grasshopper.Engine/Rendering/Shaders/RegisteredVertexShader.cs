	...
	public class RegisteredVertexShader : IDisposable
	{
		...
		public RegisteredVertexShader(ShaderBytecode bytecode)
		{
			...
			_inputElements = new[]
			{
				...
				new InputElement("WVPROJ", 0, Format.R32G32B32A32_Float, 0, 1, InputClassification.PerInstanceData, 1),
				new InputElement("WVPROJ", 1, Format.R32G32B32A32_Float, 16, 1, InputClassification.PerInstanceData, 1),
				new InputElement("WVPROJ", 2, Format.R32G32B32A32_Float, 32, 1, InputClassification.PerInstanceData, 1),
				new InputElement("WVPROJ", 3, Format.R32G32B32A32_Float, 48, 1, InputClassification.PerInstanceData, 1),
